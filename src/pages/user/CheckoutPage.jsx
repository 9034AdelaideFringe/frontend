  ...
  useEffect(() => {
    const loadCartItems = async () => {
      try {
        ...
        setError(
          "Failed to load cart items: " + (err.message || "Unknown error")
        );
      } finally {
        setLoading(false);
      }
        ...
        >
          <div style={{ marginBottom: "10px" }}>
            <input
              ...
              defaultChecked
            />
            <label htmlFor="credit-card" style={{ marginLeft: "5px" }}>
              Credit Card
            </label>
          </div>
          ...
          <div style={{ marginBottom: "10px" }}>
            ...
            <label htmlFor="paypal" style={{ marginLeft: "5px" }}>
              PayPal
            </label>
          </div>
          ...
          <div style={{ marginBottom: "10px" }}>
            ...
            <label htmlFor="bank-transfer" style={{ marginLeft: "5px" }}>
              Bank Transfer
            </label>
          </div>
        </div>
